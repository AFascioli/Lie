...
exports.sePuedeCerrarMateria = async (idMateria, idCurso, trimestre)=>{
    return new Promise((resolve, reject)=>{
        ...
        for (const inscripcion of inscripcionesFiltradas) {
            const calificacionesInscripcion= inscripcion.datosCXT[trimestre-1].calificaciones;
            let arrayCantidadConNotas= calificacionesInscripcion.filter((calificacion)=>{return calificacion!=0});
